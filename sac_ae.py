...
class Actor(nn.Module):
    ...
    def __init__(
        ...
        encoder_feature_dim, action_max, log_std_min, log_std_max, num_layers, num_filters, stride, encoder_max_norm=None,
    ):
        super().__init__()
        ...
        self.encoder = make_encoder(
            ...
            num_filters, stride, max_norm=encoder_max_norm
        )
...
class Critic(nn.Module):
    ...
    def __init__(
        self, obs_shape, action_shape, hidden_dim, encoder_type,
        encoder_feature_dim, num_layers, num_filters, stride, encoder_max_norm=None
    ):
        super().__init__()
