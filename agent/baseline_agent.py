...
class BaselineAgent(object):
    ...
    def __init__(
        ...
        if encoder_max_norm == False: encoder_max_norm = None
        ...
        self.actor = Actor(
            ...
            num_layers, num_filters, encoder_stride, encoder_max_norm
        ).to(device)
    ...
    def select_action(self, obs, **kwargs): # TODO torch_mode
        with torch.no_grad():
